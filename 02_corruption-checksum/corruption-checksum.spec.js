describe('Corruption Checksum (Part one) - .calculateChecksum', function() {
  let corruptionChecksum;

  beforeEach(function() {
    corruptionChecksum = new CorruptionChecksum();
  });

  it('should be able solve an input', function() {
    const result = corruptionChecksum.calculateChecksum([
      [5, 1, 9, 5],
      [7, 5, 3],
      [2, 4, 6, 8]
    ]);
  ...
  it('should be able solve an input 2', function() {
    const result = corruptionChecksum.calculateChecksum([
      [5, 2, 9, 5],
      [17, 5, 3],
      [11, 3, 4, 38, 31]
  ...
  it('should be able solve an input with large number of rows', function() {
    const result = corruptionChecksum.calculateChecksum([
    ...
    expect(result).toEqual(44216);
  });
});

describe('Corruption Checksum (Part two) - .sumResultOfWholeDivisions', function() {
  let corruptionChecksum;
  ...
  it('should be able solve an input', function() {
    const result = corruptionChecksum.sumResultOfWholeDivisions([
      [5, 9, 2, 8],
      [9, 4, 7, 3],
      [3, 8, 6, 5]
    ]);
